...
DrLibphonenumberBindings(ffi.DynamicLibrary dynamicLibrary): _lookup = dynamicLibrary.lookup;

/// The symbols are looked up with [lookup].
DrLibphonenumberBindings.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup): _lookup = lookup;

/// Format the [phone_number] using the [phone_number_format].
ffi.Pointer<LibPhoneNumberResult_c_char> format(
...
late final _formatPtr = _lookup<ffi.NativeFunction<ffi.Pointer<LibPhoneNumberResult_c_char> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , ffi.Int32 )>>('format');
late final _format = _formatPtr.asFunction<ffi.Pointer<LibPhoneNumberResult_c_char> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> , int )>();
...
late final _get_number_typePtr = _lookup<ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('get_number_type');
late final _get_number_type = _get_number_typePtr.asFunction<int Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();

ffi.Pointer<ffi.Char> getRegionCodeForCountryCode(
  int callingCode,
) {
...
late final _getRegionCodeForCountryCodePtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(ffi.Uint16 )>>('getRegionCodeForCountryCode');
late final _getRegionCodeForCountryCode = _getRegionCodeForCountryCodePtr.asFunction<ffi.Pointer<ffi.Char> Function(int )>();
...
late final _getRegionInfoPtr = _lookup<ffi.NativeFunction<ffi.Pointer<RegionInfo> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('getRegionInfo');
late final _getRegionInfo = _getRegionInfoPtr.asFunction<ffi.Pointer<RegionInfo> Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();
...
late final _isValidPhoneNumberPtr = _lookup<ffi.NativeFunction<ffi.Int Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>>('isValidPhoneNumber');
late final _isValidPhoneNumber = _isValidPhoneNumberPtr.asFunction<int Function(ffi.Pointer<ffi.Char> , ffi.Pointer<ffi.Char> )>();
...
late final _free_memoryPtr = _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Void> )>>('free_memory');
late final _free_memory = _free_memoryPtr.asFunction<void Function(ffi.Pointer<ffi.Void> )>();
...
class LibPhoneNumberResult_c_char extends ffi.Struct{
